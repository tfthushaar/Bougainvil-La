...
export function SignatureExperiences({ content }: { content: HomeContent }) {
  return (
    <section style={{ background: 'var(--color-surface-3)', borderTop: '1px solid var(--color-line)' }}>
      <div style={{
        ...
        <div>
          <h2 className="font-display" data-edit-field="home:singleton.signatureExperiencesHeadline" data-edit-value={content.signatureExperiencesHeadline} style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {content.signatureExperiences.map((f, i) => (
              <div key={f.title} style={{
                ...
                <div>
                  <h3 className="font-display" style={{ fontWeight: 500, fontSize: '1.1rem', color: 'var(--color-ink)', margin: f.desc ? '0 0 0.35rem' : 0 }}>{f.title}</h3>
                  {f.desc && (
