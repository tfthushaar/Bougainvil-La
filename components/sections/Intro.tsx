  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: '48rem', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        <h2 className="font-display" data-edit-field="home.introHeadline" data-edit-value={content.introHeadline} style={{
          fontStyle: 'italic', fontWeight: 500, fontSize: 'clamp(1.8rem, 3.6vw, 2.6rem)',
          color: 'var(--color-ink)', margin: 0,
        }}>
          {content.introHeadline}
        </h2>
        <p data-edit-field="home.introParagraph" data-edit-value={content.introParagraph} style={{
